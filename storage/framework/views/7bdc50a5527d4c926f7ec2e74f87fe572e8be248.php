            ...
            <div class="c_kabinet-profile">
                <div class="c_kabinet-profile__akk">
                    ...
                    <div class="c_kabinet-profile__top">
                        ...
                        <div class="c_kabinet-profile__col">
                            ...
                            <div class="c_kabinet-profile__box">
                                ...
                                <div class="c_kabinet-profile__place">
                                    <input type="text" value="<?php echo e(trans(
                                        sprintf('admin_users.fields.country.%s', $user->country)
                                    )); ?>" readonly>
                                </div>
                            </div>
                            <div class="c_kabinet-profile__box">
                            ...
                            <div class="c_kabinet-profile__box">
                                ...
                                <div class="c_kabinet-profile__place">
                                    <input type="text" value="<?php echo e(trans(
                                        sprintf('admin_users.fields.sex.%s', $user->sex)
                                    )); ?>" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="c_kabinet-soc__col">
                            ...
                            <?php if($facebook !== null): ?>
                                <div class="c_kabinet-profile__place c_kabinet-soc__item c_kabinet-soc__fb">
                                    <input type="text" value="<?php echo e($facebook->provider_user_id); ?>" readonly>
                                </div>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="c_kabinet-bottom">
                        ...
                        <a href="<?php echo e(route('profile.edit', $user->id)); ?>" class="c_kabinet-edit">Редактировать профиль</a>
                    </div><!-- .kabinet-bottom -->
                </div>
            </div><!-- .kabinet-profile -->
